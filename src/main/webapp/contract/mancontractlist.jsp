...
<form id="pagerForm" method="post" action="/oa/contract/mancontractList.action">
...
<div class="panelBar">
		<ul class="toolBar">
			<li><a class="edit" href="/oa/contract/viewmancontract.action?contract.id={sid_obj}" target="navTab" rel="subMain"><span>查看</span></a></li>
		</ul>
	</div>
	...
	<table class="table" width="100%" layoutH="76">
		...
		<s:iterator value="pagination.result" id="obj">
			<tr target="sid_obj" rel="<s:property value="id" />">
				<td>
				<a href="/oa/contract/viewmancontract.action?contract.id=${obj.id}" target="navTab" rel="viewMain">${obj.title}</a>
				</td>				
