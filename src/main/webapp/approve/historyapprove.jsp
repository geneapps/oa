...
<form id="pagerForm" method="post" action="/oa/approve/historyapprove.action">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="/oa/approve/historyapprove.action" method="post">
	<div class="searchBar">
		<table class="searchContent">
			<tr>
				<td>
				标题
				<input type="text" name="application.title"/>
				</td>
				<td>
				申请人
				<input type="text" name="application.user.realName"/>
				</td>
				<td>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
	<li><a class="edit" href="/oa/approve/view.action?application.id={sid_obj}" target="navTab" rel="editapprove"><span>查看</span></a></li>
		</ul>
	</div>
	<table class="table" width="100%" layoutH="342">
		<thead>
			<tr>
				...
				<th width="300" align="center">申请名称</th>				
				<th width="100" align="center">经手人</th>
				<th width="100" align="center">所属部门</th>
				<th width="100" align="center">总金额（单位：元）</th>
		...
		<s:iterator value="pagination.result" id="obj">
			...
			<s:elseif test="#obj.applyType == 'CONTRACT'">合同审批</s:elseif>
			...
			<td><s:property value="user.department.depName" /></td>
			<td><s:property value="total Amount" /></td><!-- 用来显示总金额 -->
