...
<form id="pagerForm" method="post" action="/oa/purchaseapply/mylist.action">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="edit" href="/oa/purchase/viewpurchaseapply.action?purchaseApply.id={sid_obj}" target="navTab" rel="subMain"><span>查看</span></a></li>
		</ul>
	</div>
	<table class="table" width="100%" layoutH="86">
		<thead>
			<tr>
				...
				<th width="100" align="center">预算总金额</th>
				<!-- <th align="center" width="100">预支金额</th> -->
				<th width="180" align="center">采购时间</th>
				<th width="180" align="center">申请时间</th>
				<th align="center" width="100">采购人</th>
				<th align="center" width="100">申请人</th>
			</tr>
		</thead>
		<tbody>
		<s:iterator value="pagination.result" id="obj">
			...
			<td>
				...
				<s:elseif test="status==2">开始采购</s:elseif>
			...
			<td><s:property value="buyUser.realName" /></td>
