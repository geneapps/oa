...
<form action="/oa/common/fileupload.action" method="post" enctype="multipart/form-data" class="pageForm required-validate" onsubmit="return iframeCallback(this, $.bringBack)">
...
<div class="pageContent">
	<div class="pageFormContent" layoutH="97">
		<dl>
			<dt>附件：</dt><dd><input type="file" name="uploadFile" class="required" size="30" /></dd>
		</dl>
	</div>
	<div class="formBar">
		<ul>
