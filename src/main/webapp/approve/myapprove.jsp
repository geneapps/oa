...
<form id="pagerForm" method="post" action="/oa/approve/myapprove.action">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
	<li><a class="edit" href="/oa/approve/approve.action?application.id={sid_obj}" rel="editapprove" target="dialog"><span>审批</span></a></li>
		</ul>
	</div>
